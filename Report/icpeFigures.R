...
# forest ----
windows <- c("0_7", "8_28", "29_90", "91_180", "181_365", "366_Inf")
...
dataHR <- data$risk %>%
  ...
  filter(window %in% c("0_7", "8_28", "29_90", "91_180", "181_365", "366_Inf")) |>
  ...
  mutate(
    ...
    window = factor(
      window,
      levels = c("0_7", "8_28", "29_90", "91_180", "181_365", "366_Inf"),
      labels = paste0(gsub("_", " to ", c("0_7", "8_28", "29_90", "91_180", "181_365", "> 365")), " days")
    ),
