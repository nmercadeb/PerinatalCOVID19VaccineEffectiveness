...
# TTE
cat("\n\n\\pagebreak\n")
cat("## ", paste0("**Appendix Text ", num_text, ":** Specifications of the target trials."))
cat("\n")
num_text <- num_text + 1
cat("\n")
...
cat("\n\n\\pagebreak\n")
cat("## ", paste0("**Appendix Figure ", num_figure, ":** Hazard ratios for COVID-19 infection and COVID-19-related hospitalization, stratified by vaccine product, across databases, and analysis"))
num_figure <- num_figure + 1
cat("\n")
...
nco <- data$risk |>
    ...
    filter(
        strata_name == "overall", covid_definition == "diagnostic_test", 
        cdm_name %in% c("SCIFI-PEARL", "UiO", "SIDIAP", "CPRD GOLD", "META-ANALYSIS"),
        regression == "cox-sandwich", followup_end == "cohort_end_date_pregnancy",  variable_name == "nco"
    ) |>
    splitStrata() |>
    pivot_wider(names_from = "estimate_name", values_from = "estimate_value") |>
    mutate(
